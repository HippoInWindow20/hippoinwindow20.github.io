...
switch (subjectDefined) {
    ...
    case "math":
        ...
        subject = "數學";
        cname = "張老師";
        desc = "雖然教學進度緊湊，但上課節奏比想像中還來得輕緩。敘述老嫗能解，幫助我們熟悉每堂吸收的新觀念。為了非常努力的在趕課，讓我們不至於和目前進度差太遠。";
        break;
    case "physics":
        titleColour = green;
        subject = "物理";
        cname = "林老師";
        desc = "對於相對非直覺而不易理解的物理領域，林老師都可有條有理的依序講解每個概念的邏輯推導以及和其他概念的連結與推廣。對於不認真聽課或精神不佳而打盹的同學會予其嚴厲勸導，督促同學認真向學勿懈怠。 ";
        break;
    case "chemistry":
        titleColour = blue;
        subject = "化學";
    ...
    case "history":
        ...
        subject = "歷史";
        cname = "羅老師";
        desc = "身為二類組的社會科教師之一，羅老師授課時常運用各種講解深刻的影片和考前發下的「必勝卷」幫助我們不需另外花心思在歷史。";
        break;
    case "geography":
        titleColour = blue;
        subject = "地理";
        cname = "郭老師";
        desc = "在度過最難的第一冊之後，課堂內容逐漸轉為輕鬆活潑，老師也因此在課堂中後段播送有趣的影片讓我們在經歷一整天各科的千錘百鍊後得以好好休息。考前會提供輔助題庫協助我們準備。";
        break;
    case "social":
        titleColour = red;
        subject = "公民";
        cname = "韓老師";
        desc = "同樣慢活上課的韓老師，在每章上完之後發下複習卷為每章作結，同時以輔助題庫讓同學準備段考較不會迷失方向。老師的每節公民課都格外熱鬧。";
        break;
    case "cs":
        titleColour = yellow;
        subject = "資訊科學";
    ...
    case "pe":
        ...
        subject = "體育";
        cname = "吳老師";
        desc = "每節課帶我們鍛鍊身體的吳老師，常因我們偶爾的考試而帶書下來複習，或不斷地延後下課而感到相當煩躁。老師每當遇到天氣狀況良好的課都會叮囑我們加緊練習。";
        break;
    case "life":
        titleColour = blue;
        subject = "生命教育";
        cname = "鄧老師";
        desc = "每節課配合不同授課參考資料(音樂影片，卡牌，學習單...)試著活絡課堂氣氛的生命教育課。";
        break;
    case "music":
        titleColour = red;
        subject = "音樂";
        cname = "王老師";
        desc = "聲稱少吸空氣減肥法的王老師，教授我們基本音樂史和基礎樂理。考試模式通常相當格外不同，讓我們對音樂課留下不錯的印象。";
        break;
    case "engcon_a":
        titleColour = yellow;
        subject = "英語會話 A";
